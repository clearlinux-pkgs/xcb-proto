...
Source0  : https://www.x.org/releases/individual/proto/xcb-proto-1.14.1.tar.xz
Source1  : https://www.x.org/releases/individual/proto/xcb-proto-1.14.1.tar.xz.sig
...
%prep
%setup -q -n xcb-proto-1.14.1
cd %{_builddir}/xcb-proto-1.14.1
pushd ..
cp -a xcb-proto-1.14.1 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608097836
...
cp %{_builddir}/xcb-proto-1.14.1/COPYING %{buildroot}/usr/share/package-licenses/xcb-proto/1d6467e08284270291d138c7ea07f24689483068
pushd ../build32/
%make_install32
